...
export function Contact() {
  return(
    <div className="px-0 py-24 md:px-24 md:py-48 lg:px-48 ">
      <Card className="max-w-[48rem] md:flex-column lg:flex-row m-auto">
        <CardBody>
          <Typography variant="h2" color="black" className="mb-4 uppercase">
            Let's Talk
          </Typography>
          <Typography variant="p" color="gray" className="mb-2">
            Interested in our mission or want to get involved? Then reach out, we'd love to hear your ideas or answer any questions you have about project Elevate!
          </Typography>
          ...
          <ul class="mt-4">
            <li class="flex items-center">
              <a class="flex" href="mailto:info@projectelevate.us">
                ...
                <div class="text-[#007bff] text-sm ml-4">
                    <small class="block">Mail</small>
                    <strong>info@projectelevate.us</strong>
                </div>
              </a>
            </li>
          </ul>
          ...
          <ul class="flex mt-4 space-x-4">
            ...
            <li class="flex items-center">
              <a class="flex" href="https://linkedin.com/company/project-elevate-edtech">
                <div class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#007bff'
                      viewBox="0 0 511 512">
                      <path
